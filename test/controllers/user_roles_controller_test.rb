...
class UserRolesControllerTest < ActionController::TestCase
  ...
  test "should create user_role" do
    assert_difference('UserRole.count') do
      post :create, user_role: { description: @user_role.description, title: @user_role.title, visible: @user_role.visible }
    end
  ...
  test "should update user_role" do
    patch :update, id: @user_role, user_role: { description: @user_role.description, title: @user_role.title, visible: @user_role.visible }
    assert_redirected_to user_role_path(assigns(:user_role))
  end
