...
class WarehousesControllerTest < ActionController::TestCase
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post :create, warehouse: { address: @warehouse.address, creator_id: @warehouse.creator_id, description: @warehouse.description, fax: @warehouse.fax, phone: @warehouse.phone, title: @warehouse.title, visible: @warehouse.visible }
    end
  ...
  test "should update warehouse" do
    patch :update, id: @warehouse, warehouse: { address: @warehouse.address, creator_id: @warehouse.creator_id, description: @warehouse.description, fax: @warehouse.fax, phone: @warehouse.phone, title: @warehouse.title, visible: @warehouse.visible }
    assert_redirected_to warehouse_path(assigns(:warehouse))
  end
